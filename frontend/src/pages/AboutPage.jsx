      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 border-2 rounded-2xl -z-10" style={{ borderColor: `${primaryColor}20` }}></div>
          </div>
        </div>
        ...
        >
          <div className="relative">
            ...
            <div className="absolute -top-4 -left-4 w-32 h-32 border rounded-2xl -z-10" style={{ borderColor: `${secondaryColor}20` }}></div>
          </div>
          <div>
            <div className="flex items-center gap-4 mb-6">
              <div
        ...
        >
          <div className="relative lg:order-2">
            ...
            <div className="absolute -bottom-4 -right-4 w-28 h-28 border-2 rounded-2xl -z-10" style={{ borderColor: `${primaryColor}20` }}></div>
          </div>
          <div className="lg:order-1">
            <div className="hidden lg:flex items-center gap-4 mb-6">
              <div
