...
const AboutPage = () => {
  ...
  return (
    <div className="bg-white pt-8 lg:pt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        {/* Story Section - No animation, image on right */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-20 lg:mb-24">
          {/* Content - Left side */}
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <div className="relative rounded-2xl overflow-hidden w-full max-w-md lg:max-w-lg">
              <img
                src={
                  aboutData?.story_image ||
                  "https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
        ...
        <div
          data-section="mission"
          className={`grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-20 lg:mb-24 transition-all duration-700 
            ${isVisible.mission ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          {/* Image - Left side */}
          ...
          <div>
            <div className="flex items-center gap-4 mb-6">
              <div
                className="p-3 lg:p-4 rounded-xl lg:rounded-2xl transition-all duration-300 hover:scale-110 flex-shrink-0"
                style={{
                  backgroundColor: `${primaryColor}10`,
                  color: primaryColor,
                }}
        ...
        >
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="hidden lg:flex items-center gap-4 mb-6">
              <div
                className="p-4 rounded-2xl transition-all duration-300 hover:scale-110 flex-shrink-0"
                style={{
                  backgroundColor: `${secondaryColor}10`,
                  color: secondaryColor,
                }}
