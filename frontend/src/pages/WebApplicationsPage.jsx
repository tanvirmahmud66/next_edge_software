...
//         "/api/resource/Web Application Page/Web Application Page",
//         {
//           method: "GET",
//           headers: {
...
//     try {
//       const response = await fetch(
//         '/api/resource/Web Application Type?fields=["name", "type_name", "description", "image"]',
//         {
//           method: "GET",
//           headers: {
//             "Content-Type": "application/json",
...
//                 `/api/resource/Web Application Type/${encodeURIComponent(type.name)}`,
//                 {
//                   method: "GET",
//                   headers: {
//                     "Content-Type": "application/json",
...
//             } catch (err) {
//               console.error(
//                 `Error fetching details for type ${type.name}:`,
//                 err,
//               );
//               return type;
//             }
...
//     try {
//       const response = await fetch(
//         '/api/resource/Feature?fields=["name", "feature_name", "description"]',
//         {
//           method: "GET",
//           headers: {
//             "Content-Type": "application/json",
...
//             try {
//               const detailResponse = await fetch(
//                 `/api/resource/Feature/${encodeURIComponent(feature.name)}`,
//                 {
//                   method: "GET",
//                   headers: {
//                     "Content-Type": "application/json",
...
//             } catch (err) {
//               console.error(
//                 `Error fetching details for feature ${feature.name}:`,
//                 err,
//               );
//               return feature;
//             }
...
//     try {
//       const response = await fetch(
//         '/api/resource/Development Process?fields=["name", "process_name", "description", "process_step", "icon"]',
//         {
//           method: "GET",
//           headers: {
//             "Content-Type": "application/json",
...
//             try {
//               const detailResponse = await fetch(
//                 `/api/resource/Development Process/${encodeURIComponent(process.name)}`,
//                 {
//                   method: "GET",
//                   headers: {
//                     "Content-Type": "application/json",
...
//             } catch (err) {
//               console.error(
//                 `Error fetching details for process ${process.name}:`,
//                 err,
//               );
//               return process;
//             }
...
//         const sortedProcesses = processesWithDetails.sort(
//           (a, b) => (a.process_step || 0) - (b.process_step || 0),
//         );
...
//           {/* Same layers as loading, omitted for brevity but included in actual code */}
//           <div
...
//           />
//           {/* ... full layers from loading state ... */}
//         </div>
...
//             {/* Left Content */}
//             <div
//               className={`transition-all duration-700 ${isVisible["hero"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
//             >
//               {pageData?.hero_badge && (
...
//             {pageData?.hero_image && (
//               <div
//                 className={`relative hidden lg:block transition-all duration-700 ${isVisible["hero"] ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}
//               >
...
//                 {pageData?.application_type_badge || "Web Application Types"}
//               </span>
//             </div>
//             <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
//               {pageData?.application_type_title ||
//                 "Solutions for Every Business Need"}
//             </h2>
//             <p className="text-white/70 text-lg">
//               {pageData?.application_type_subtitle ||
//                 "From e-commerce to enterprise, we build web applications for every industry and use case."}
//             </p>
//           </div>
...
//                       {type.description}
//                     </p>
//                     {type.type_items?.length > 0 ? (
//                       <ul className="space-y-2 mb-4">
//                         {type.type_items.map((item, i) => (
//                           <li
//                             key={i}
...
//                       </ul>
//                     ) : (
//                       <div className="text-white/50 text-sm mb-4 italic">
//                         No features listed
//                       </div>
//                     )}
//                     <a
//                       href="#learn-more"
//                       className="inline-flex items-center gap-2 text-white font-medium mt-auto group-hover:gap-3 transition-all"
//                     >
//                       Learn More
...
//               <span className="text-white">
//                 {pageData?.feature_section_badge || "Key Features"}
//               </span>
//             </div>
//             <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
//               {pageData?.feature_section_title ||
//                 "What Makes Our Web Apps Exceptional"}
//             </h2>
//             <p className="text-white/70 text-lg">
//               {pageData?.feature_section_subtitle ||
//                 "We build applications with the latest technologies and best practices."}
//             </p>
//           </div>
...
//                       <ul className="space-y-2 mb-4">
//                         {feature.feature_items.map((item, i) => (
//                           <li
//                             key={i}
//                             className="flex items-center gap-2 text-sm text-white/80"
//                           >
...
//               <span className="text-white">
//                 {pageData?.process_badge || "Development Process"}
//               </span>
//             </div>
//             <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
...
//                       {process.description}
//                     </p>
//                     {process.process_items?.length > 0 ? (
//                       <ul className="space-y-2">
//                         {process.process_items.map((item, i) => (
//                           <li
//                             key={i}
//                             className="flex items-center gap-2 text-sm text-white/80"
//                           >
...
//                   "Got questions about web application development? We've got answers."}
//               </p>
//             </div>
...
//                     </div>
//                     <ChevronRight
//                       className={`w-5 h-5 transition-all duration-300 ${openFaqIndex === index ? "rotate-90" : ""}`}
//                       style={{ color: colors.accent2 }}
//                     />
//                   </button>
//                   <div
//                     className={`px-6 overflow-hidden transition-all duration-300 ${openFaqIndex === index ? "pb-6 max-h-40" : "max-h-0"}`}
//                   >
...
//                 "Let's discuss your project requirements and see how we can help you achieve your business goals with a custom web application."}
//             </p>
...
//                   className="group px-8 py-4 rounded-lg font-semibold transition-all duration-200 flex items-center gap-2 border-2"
//                   style={{ borderColor: colors.accent2, color: "white" }}
//                   onMouseEnter={(e) => {
//                     e.currentTarget.style.backgroundColor = colors.accent2;
//                   }}
//                   onMouseLeave={(e) => {
...
//               <div
//                 className="grid md:grid-cols-3 gap-6 pt-8 max-w-2xl mx-auto"
//                 style={{ borderTop: `1px solid ${colors.accent1}60` }}
//               >
//                 {pageData.phone && (
//                   <a
...
//                       style={{ background: `${colors.accent2}30` }}
//                     >
//                       <Phone
//                         className="w-4 h-4"
//                         style={{ color: colors.accent2 }}
...
//                     <div
//                       className="p-2 rounded-full"
//                       style={{ background: `${colors.accent1}30` }}
//                     >
//                       <Mail
//                         className="w-4 h-4"
...
const WebApplicationsPage = () => {
  ...
  // Icons mapping for features
  const getIconForFeature = useCallback((featureName) => {
    const iconMap = {
      Responsive: <Smartphone className="w-6 h-6" />,
      Performance: <Gauge className="w-6 h-6" />,
      Security: <Shield className="w-6 h-6" />,
  ...
  // Icons mapping for process steps
  const getIconForProcess = useCallback((processName) => {
    const iconMap = {
      Discovery: <ClipboardList className="w-6 h-6" />,
      Planning: <ClipboardList className="w-6 h-6" />,
      Design: <PenTool className="w-6 h-6" />,
  ...
  // Format step number with leading zero
  const formatStepNumber = useCallback((step) => {
    return step < 10 ? `0${step}` : `${step}`;
  }, []);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full border-2 border-gray-200 border-t-[#008071] animate-spin mx-auto mb-4"></div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center max-w-md px-4">
          <HelpCircle className="w-16 h-16 mx-auto mb-4 text-[#008071]" />
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ref={(el) => (sectionRefs.current["hero"] = el)}
        className="relative pt-32 lg:pt-40 pb-20 lg:pb-16"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                {pageData?.hero_primary_button_title && (
                  <a
                    href={pageData.hero_primary_action || "#contact"}
                    className="group px-8 py-4 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:translate-y-0 flex items-center gap-2 text-white"
                    style={{ backgroundColor: colors.accent2 }}
                  >
                    {pageData.hero_primary_button_title}
                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                ...
                {pageData?.hero_secondary_button_title && (
                  <a
                    href={pageData.hero_secondary_action || "#showcase"}
                    className="group px-8 py-4 rounded-xl font-semibold transition-all duration-200 flex items-center gap-2 border-2"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              <Globe className="w-4 h-4" />
              <span>{pageData?.application_type_badge || "Web Application Types"}</span>
            </div>
          ...
          {typesData.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {typesData.map((type, index) => {
                ...
                return (
                  <div
                    key={type.name}
                    className={`group relative bg-white rounded-2xl p-6 transition-all duration-500 hover:shadow-xl border border-gray-100 hover:border-transparent ${
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-gray-900">{type.type_name}</h3>
                    </div>
            ...
            <div className="text-center text-gray-500 py-12">No application types available.</div>
          )}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              ...
              <span>{pageData?.feature_section_badge || "Key Features"}</span>
            </div>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              ...
              {featuresData.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{feature.feature_name}</h3>
                    ...
                    {feature.feature_items?.length > 0 ? (
                      ...
                      <div className="flex items-center gap-2 text-gray-700 mt-auto">
                        <CheckCertificate className="w-4 h-4" style={{ color: accentColor }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              ...
              <span>{pageData?.process_badge || "Development Process"}</span>
            </div>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              {pageData?.process_title || "How We Build Web Applications"}
            </h2>
          ...
          {processData.length > 0 ? (
            <div className="grid lg:grid-cols-3 gap-6">
              {processData.map((process, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="absolute -top-3 -right-3 w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg transition-transform group-hover:scale-110 z-10"
                      style={{ backgroundColor: accentColor }}
                    >
                      {formatStepNumber(process.process_step || index + 1)}
                    </div>
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{process.process_name}</h3>
                    ...
                    {process.process_items?.length > 0 ? (
                      ...
                      <div className="text-gray-400 text-sm italic">No details listed</div>
                    )}
                    <div
                      className="absolute bottom-0 left-0 right-0 h-1 rounded-b-2xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"
                      style={{ backgroundColor: accentColor }}
            ...
            <div className="text-center text-gray-500 py-12">No process steps available.</div>
          )}
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                ...
                <span>{pageData.faq_badge || "FAQ"}</span>
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                {pageData.faq_title || "Frequently Asked Questions"}
              </h2>
            ...
            <div className="space-y-3">
              {pageData.faq_items.map((faq, index) => (
                <div
                  ...
                  style={{
                    borderColor: openFaqIndex === index ? colors.accent2 : '#E5E7EB',
                    transitionDelay: `${index * 100}ms`,
                  }}
                >
                  <button
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <HelpCircle
                        ...
                        style={{ color: openFaqIndex === index ? colors.accent2 : '#9CA3AF' }}
                      />
                      <span className={`font-medium ${openFaqIndex === index ? 'text-gray-900' : 'text-gray-700'}`}>
                        {faq.primary_value}
                      </span>
                    </div>
                    <ChevronRight
                      className={`w-5 h-5 transition-all duration-300 flex-shrink-0 ${openFaqIndex === index ? "rotate-90" : ""}`}
                      style={{ color: colors.accent2 }}
                    />
                  </button>
                  <div
                  ...
                  >
                    <div className="pl-8">
                      <p className="text-gray-600 text-sm leading-relaxed">{faq.secondary_value}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="text-center mt-12">
              <p className="text-gray-500 text-sm mb-4">Still have questions about web development?</p>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-medium text-white transition-all hover:shadow-lg"
                style={{ backgroundColor: colors.accent2 }}
              >
      ...
      {pageData?.cta_badge && (
        <section className="py-20 lg:py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            {(pageData.phone || pageData.email || pageData.web_url) && (
              <div className="grid md:grid-cols-3 gap-6 pt-8 max-w-2xl mx-auto border-t border-gray-200">
                {pageData.phone && (
                  <a
                    href={`tel:${pageData.phone}`}
                    className="flex items-center justify-center gap-3 text-gray-600 hover:text-gray-900 transition-colors"
                  >
                    <div className="p-2 rounded-full" style={{ backgroundColor: `${colors.accent2}10` }}>
                ...
                {pageData.email && (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 text-gray-600 hover:text-gray-900 transition-colors"
                  >
                    <div className="p-2 rounded-full" style={{ backgroundColor: `${colors.accent1}10` }}>
                ...
                {pageData.web_url && (
                  <div className="flex items-center justify-center gap-3 text-gray-600">
                    <div className="p-2 rounded-full" style={{ backgroundColor: `${colors.secondary}10` }}>
            ...
            {pageData.trust_badge && (
              <div className="mt-8">
                <span className="text-sm text-gray-500">{pageData.trust_badge}</span>
              </div>
            )}
          </div>
        </section>
...
export default memo(WebApplicationsPage);
