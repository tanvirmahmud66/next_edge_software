...
// // ============ STATIC IMAGE COMPONENT (NO AUTO-SCROLL) ============
...
// // ============ SIMPLE 3-COLUMN GRID (NO HOVER EFFECTS, NO ANIMATIONS) ============
...
//             }}
//           >
//             <AutoScrollImage src={item.image} alt={item.title || "Project"} />
...
//           style={{
//             background: `linear-gradient(90deg, #008170, #005B41)`,
//           }}
//         />
//       </span>
//     );
...
//     title: homePageData?.showcase_title || "Website Demos",
//     subtitle:
...
//             <p className="text-white/80 text-lg opacity-0 animate-fade-in-up stagger-2">{showcaseContent.subtitle}</p>
//           </div>
    ...
    <>
      <section className="py-20 lg:py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium mb-4 border border-white/20 opacity-0 animate-fade-in-up">
              <Rocket className="w-4 h-4" style={{ color: "#008170" }} />
              <span className="text-white">{showcaseContent.badge}</span>
            </div>
          ...
          {!loading && !error && items.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-white/60 text-lg">No projects available at the moment</p>
              ...
              {visibleCount < items.length && (
                <div ref={loadMoreRef} className="flex justify-center mt-12">
                  ...
                  >
                    ...
                    <p className="text-white/40 text-xs mt-1">
                      {remainingItems} more project{remainingItems !== 1 ? "s" : ""} available
                    </p>
                  </button>
                </div>
              )}
