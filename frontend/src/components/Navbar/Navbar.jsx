        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
              ...
              {navItems.map((item) => (
                ...
                >
                  {item.hasDropdown ? (
                    <>
                      <button
                        className={`flex items-center space-x-1 px-3 lg:px-4 py-2 rounded-lg font-medium text-sm lg:text-base transition-all duration-200 cursor-pointer ${
                          activeDropdown === item.id
                            ? "text-gray-900 bg-gray-100"
                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                        }`}
                        style={{
                          color: activeDropdown === item.id ? primaryColor : undefined,
                          backgroundColor: activeDropdown === item.id ? `${primaryColor}10` : undefined,
                        }}
                        aria-expanded={activeDropdown === item.id}
                        aria-haspopup="true"
                      >
                      ...
                      {activeDropdown === item.id && (
                        <div
                          className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-96 rounded-xl shadow-2xl overflow-hidden bg-white border border-gray-200"
                          onMouseEnter={() => handleDropdownEnter(item.id)}
                          onMouseLeave={handleDropdownLeave}
                        >
                              ...
                              <div key={colIndex}>
                                ...
                                <div className="space-y-1">
                                  {column.items.map((dropdownItem, itemIndex) => (
                                    ...
                                    >
                                      <span className="mt-0.5" style={{ color: primaryColor }}>
                                        {dropdownItem.icon}
                                      </span>
                                      <div className="flex-1">
                                        <div className="flex items-center justify-between">
                    ...
                    <Link
                      to={item.to}
                      className="inline-block px-3 lg:px-4 py-2 rounded-lg text-gray-600 hover:text-gray-900 font-medium text-sm lg:text-base transition-all duration-200 hover:bg-gray-50 cursor-pointer"
                    >
                      {item.name}
                    </Link>
                  )}
            ...
            <div className="hidden md:block flex-shrink-0">
              <button
                onClick={openModal}
                className="text-white px-5 lg:px-6 py-2.5 rounded-lg text-sm lg:text-base font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0 flex items-center gap-2 cursor-pointer"
                style={{ backgroundColor: primaryColor }}
              >
                <Download className="w-4 h-4" />
                Download Brochure
            ...
            <div className="flex md:hidden">
              <button
                onClick={toggleMenu}
                type="button"
                className="inline-flex items-center justify-center p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none transition-all cursor-pointer"
                aria-expanded={isOpen}
                aria-label="Toggle navigation menu"
              >
                {isOpen ? (
        ...
        >
          <div className="px-4 pt-2 pb-6 bg-white border-t border-gray-200">
                ...
                {item.hasDropdown ? (
                  <div className="py-2">
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-3 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-50 text-base font-medium transition-colors cursor-pointer"
                    >
                      <span>{item.name}</span>
                      <ChevronDown className="w-4 h-4 transition-transform duration-200" />
                    </button>
                          ...
                          <div key={colIndex} className="space-y-1">
                            ...
                            {column.items.map((dropdownItem, itemIndex) => (
                              <Link
                                key={itemIndex}
                                to={dropdownItem.to}
                                className="flex items-start space-x-3 px-3 py-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 text-sm transition-colors cursor-pointer"
                                onClick={toggleMenu}
                              >
                                <span className="mt-0.5" style={{ color: primaryColor }}>
                                  {dropdownItem.icon}
                  ...
                  <Link
                    to={item.to}
                    className="block px-3 py-3 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-50 text-base font-medium transition-colors cursor-pointer"
                    onClick={toggleMenu}
                  >
                    {item.name}
                  </Link>
            ...
            <button
              ...
              className="w-full text-center text-white px-3 py-3 rounded-lg text-base font-semibold transition-all duration-200 mt-6 shadow-md flex items-center justify-center gap-2 cursor-pointer"
              style={{ backgroundColor: primaryColor }}
            >
              <Download className="w-4 h-4" />
              Download Brochure
            ...
            <div className="mt-6 pt-4 space-y-3 border-t border-gray-200">
              <a
                href="tel:+8801701744799"
                className="flex items-center space-x-3 px-3 text-gray-600 hover:text-gray-900 text-sm transition-colors cursor-pointer"
              >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={handleInputChange}
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-[#008071] focus:ring-2 focus:ring-[#008071]/20 transition-all text-gray-900 placeholder-gray-400 outline-none"
                  placeholder="Enter your full name"
                />
                {formErrors.name && (
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    value={formData.countryCode}
                    onChange={handleCountryCodeChange}
                    className="px-3 py-2.5 rounded-lg border border-gray-300 focus:border-[#008071] focus:ring-2 focus:ring-[#008071]/20 transition-all text-gray-900 bg-white outline-none cursor-pointer"
                  ...
                  <input
                    ...
                    value={formData.phone}
                    onChange={handleInputChange}
                    className="flex-1 px-4 py-2.5 rounded-lg border border-gray-300 focus:border-[#008071] focus:ring-2 focus:ring-[#008071]/20 transition-all text-gray-900 placeholder-gray-400 outline-none"
                    placeholder="Phone number"
                  />
                </div>
                {formErrors.phone && (
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-3 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer text-white"
                style={{ backgroundColor: primaryColor }}
              >
                {isSubmitting ? (
                  <>
